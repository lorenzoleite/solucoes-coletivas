    ...
    return(
        <div className="home-container">
            ...
            <div className="creators">
                ...
                <div className="description">
                    <img src={require('../../assets/integrada.png')} alt="Família Indígena" />
                    
                    <img src={require('../../assets/atentada.png')} alt="Família Indígena" />
                    
                    <img src={require('../../assets/agronomia.png')} alt="Família Indígena" />
                    
                    <img src={require('../../assets/analfabeta.png')} alt="Família Indígena" />
                    
                    <img src={require('../../assets/venenosa.png')} alt="Família Indígena" />
                    
                    <img src={require('../../assets/sanguinaria.png')} alt="Família Indígena" />
                    
                    <img src={require('../../assets/soberana.png')} alt="Família Indígena" />
